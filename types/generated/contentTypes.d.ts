...
export interface ApiAllergeneAllergene extends Struct.CollectionTypeSchema {
  collectionName: 'allergenes';
  info: {
    displayName: 'Allergene';
    pluralName: 'allergenes';
...
export interface ApiInviteInvite extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Matin: Schema.Attribute.Component<'user.qui', true>;
